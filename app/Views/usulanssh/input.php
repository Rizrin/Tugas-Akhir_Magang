...
<div class="wizard-container">
    <div class="wizard-header">
        <h2 class="wizard-title">Penyusunan Usulan SSH Baru</h2>
        <p class="wizard-subtitle">Lengkapi seluruh formulir di bawah ini untuk mengajukan standar satuan harga baru atau pembaruan standar satuan harga yang sudah ada.</p>
    </div>
    ...
    <div class="stepper">
        ...
        <div class="step" id="stepper-2">
            ...
            <div class="step-title">Usulan SSH</div>
        </div>
    ...
    <form id="wizardForm" action="<?= base_url('usulanssh/submit') ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="step-content" id="content-2">
            <div class="form-card">
                <div class="form-section-header">
                    ...
                    <div>
                        <div class="form-section-title">Informasi Usulan SSH</div>
                        <div class="form-section-subtitle">Detail mengenai SSH yang diusulkan.</div>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <label class="radio-label"><input type="radio" name="jenis_usulan" value="SSH PERUBAHAN" checked> SSH PERUBAHAN</label>
                            <label class="radio-label"><input type="radio" name="jenis_usulan" value="SSH BARU"> SSH BARU</label>
                        </div>
                    </div>
