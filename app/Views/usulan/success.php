...
<div class="success-container">
    ...
    <p class="subtitle">Usulan SBU Anda telah berhasil didaftarkan ke dalam sistem dan akan segera diproses oleh tim validator.</p>
    ...
    <div class="details-grid">
        <div>
            <div class="card-detail">
                ...
                <div class="detail-row">
                    ...
                    <div class="detail-value">SBU Perubahan <?= esc($usulan['tahun_anggaran']) ?></div>
                </div>
                <div class="detail-row">
                ...
                <div class="action-buttons">
                    <a href="<?= base_url('usulan/input') ?>" class="btn-submit"><i class='bx bx-plus-circle'></i> Input Usulan Baru</a>
        ...
        <div>
            <div class="side-card">
                ...
                <p>Estimasi verifikasi dokumen tahap awal oleh Sekretariat SBU.</p>
            </div>
            ...
            <div class="side-card">
                ...
                <div class="process-timeline">
                    ...
                    <div class="p-step">
                        <div class="p-title">Finalisasi SBU</div>
