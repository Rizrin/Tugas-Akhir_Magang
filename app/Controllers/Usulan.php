...
class Usulan extends BaseController
{
    ...
    {
        $data = [
            'title' => 'Input SBU Baru'
        ];
        return view('usulan/input', $data);
    }
    ...
    public function submit()
    {
        ...
        $data = [
            'nomor_usulan' => 'SBU-' . date('Y') . '-' . str_pad($usulanModel->countAllResults() + 1, 3, '0', STR_PAD_LEFT),
            ...
            'nama_kegiatan'  => $this->request->getPost('kelompok_kode') ?: 'Usulan SBU',
        ...
        // Redirect to success
        return redirect()->to('/usulan/success/' . $insertId);
    }
    ...
    public function success($id)
    {
        ...
        return view('usulan/success', $data);
    }
    ...
    public function draft()
    {
        ...
        $data = [
            'q' => $searchString,
            'title' => 'Manajemen Draf',
            'drafts' => $drafts
        ];
        return view('usulan/draft', $data);
    }
    ...
    public function riwayat()
    {
        ...
        return view('usulan/riwayat', $data);
    }
    public function exportPdf()
    {
        ...
        $html = view('usulan/pdf_export', $data);
        ...
        $dompdf->stream("Riwayat_Pengajuan_SBU.pdf", ["Attachment" => true]);
        exit;
    }
    ...
    public function exportExcel()
    {
        ...
        $sheet->setTitle('Riwayat Pengajuan');
        ...
        $filename = 'Riwayat_Pengajuan_SBU_' . date('Ymd_His') . '.xlsx';
